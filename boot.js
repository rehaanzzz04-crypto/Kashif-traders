...
(async()=>{
  try{
    ...
    const extras=()=>Promise.all([load('/document-scan.js?v=20260913-clientbill1'),load('/supplier-bill-pdf-ui.js?v=20260913-supplierpdf1')]).catch(e=>console.error('Document/PDF feature unavailable',e));
