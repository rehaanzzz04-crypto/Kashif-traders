...
(async()=>{
  try{
    ...
    await load('/app.js?v=20260910-rbac2');
    await load('/inventory-ui.js?v=20260910-rbac2');
    await load('/product-status-fix.js?v=20260910-status1');
    await load('/products-scalable.js?v=20260910-rbac2');
    await load('/employees-ui.js?v=20260910-rbac2');
    await load('/role-dashboard.js?v=20260910-rbac2');
