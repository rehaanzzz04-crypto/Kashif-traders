...
(async()=>{
  try{
    ...
    if(isAdmin&&access.has('dashboard')){await load('/admin-dashboard-fix.js?v=20260913-admin8');if(typeof window.KT_OPEN_ADMIN_DASHBOARD==='function')await window.KT_OPEN_ADMIN_DASHBOARD();document.body.classList.add('auth-ready');offline();Promise.all(['/app.js?v=20260911-noautodash1','/inventory-ui.js?v=20260911-rbac3','/product-status-fix.js?v=20260910-status1','/products-scalable.js?v=20260911-barcode1','/employees-ui.js?v=20260911-rbac3','/salary-ui.js?v=20260912-polish2','/role-dashboard.js?v=20260911-rbac6'].map(load)).then(()=>{salaryExtras();extras()}).catch(console.error);return;}
    await offline();
