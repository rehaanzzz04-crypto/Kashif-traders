...
(async()=>{
  try{
    ...
    if(access.has('dashboard')&&dash){dashboard?.classList.add('hidden');module?.classList.add('hidden');dash.classList.add('active');document.body.classList.add('auth-ready');dash.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true}));return;}
